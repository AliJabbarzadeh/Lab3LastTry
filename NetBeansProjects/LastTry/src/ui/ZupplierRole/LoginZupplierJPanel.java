 ...
 */
public class LoginZupplierJPanel extends javax.swing.JPanel {
    
    private JPanel userProcessContainer;
    private ZupplierDirectory zupplierDirectory;
    public LoginZupplierJPanel(JPanel upc, ZupplierDirectory zd) {
        initComponents();
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        ...
        ZupplierWorkAreaJPanel zwajp = new ZupplierWorkAreaJPanel(userProcessContainer, zupplier);
        userProcessContainer.add("ZupplierWorkAreaJPanel", zwajp);
